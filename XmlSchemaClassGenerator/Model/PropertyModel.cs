...
public class PropertyModel(GeneratorConfiguration configuration, string name, TypeModel type, TypeModel owningType) : GeneratorModel(configuration)
{
    ...
    /// <summary>Wenn true, ist das hier das „Item“-Property einer Choice.</summary>
    public bool IsChoice { get; set; }
    /// <summary>Name der begleitenden Enum-Property (z.B. "ItemChoiceType1Value").</summary>
    public string ChoiceEnumName { get; set; }
    /// <summary>Alle möglichen Elemente, die in diesem Choice-Item stecken können.</summary>
    ...
    public List<AttributeModel>     CustomAttributes { get; } = new();
    ...
    public List<ChoiceEnumDefinition> ChoiceEnumDefinitions { get; } 
        = new List<ChoiceEnumDefinition>();

    /// <summary>Zähler für erzeugte Choice-Properties, für eindeutige Suffixe.</summary>
