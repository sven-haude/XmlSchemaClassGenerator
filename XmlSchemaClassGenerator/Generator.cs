...
using XmlSchemaClassGenerator.Services;
...
public class Generator
{
    ...
    //     ISchemaLoader? schemaLoader = null)
    // {
    //     _configuration = cfg ?? throw new ArgumentNullException(nameof(cfg));
    //     _schemaLoader  = schemaLoader ?? new DefaultSchemaLoader();
    // }
